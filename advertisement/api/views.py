...
from .serializers import Advertisement , ServiceAd, FoodAd , animalAd , clothesAd, CommentSerializer , SavedSerializer
from advertisement.models import BaseAdvertisement, Saved , ServiceAdvertisement , FoodAdvertisement , AnimalAdvertisement ,ClothAdvertisement,Comment , Saved
